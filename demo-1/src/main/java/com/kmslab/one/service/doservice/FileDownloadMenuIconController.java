...
@RestController
public class FileDownloadMenuIconController {
	
	@Autowired
	private AppConfig appConfig;
	
	@GetMapping("/menuicon.do")
	public void downloadMenuIcon(@RequestParam("code") String code, HttpServletRequest request, HttpServletResponse response) throws IOException{
		String dir = appConfig.getFileDownloadPath();
		String filePath = dir + File.separator + "appstore" + File.separator + code + ".png";
