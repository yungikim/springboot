	...
	var _cache = {}	,_debugMode = true	,_isdock = true	,_isembed = false
		...
		,_langURI = function(langpack) {
			if(Object.prototype.toString.call(langpack) == '[object Array]') {
				...
				for(var o in langpack) {
					_result[o] = window.root_path + "/res/lang/" + _lang() + "/" + langpack[o] + "." + _lang() + ".js";
				}
				return _result;
			} else {
				return window.root_path + "/res/lang/" + _lang() + "/" + langpack + "." + _lang() + ".js";		
			}
		}
		...
		,_loadModule = function(module) {
			var _mod = (typeof module === "string" ? module.split(",") : module)
				...
				,_mo = {
				"jquery" : function() {
					if(!window.$) {	_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/jquery.min.js"));}										
				}
				,"jquery.ui" : function() {
					if(!window.$ || !window.$.ui) {
						_loadCSS(window.root_path + "/res/core/jquery/jquery-ui/jquery-ui.css");
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/jquery-ui/jquery-ui.min.js"));
					}
				}
				,"jquery.plugin" : function() {
					if(_splinter) {
						_loadCSS(window.root_path + "/res/core/jquery/qtip/jquery.qtip.css");
						_loadCSS(window.root_path + "/res/core/jquery/fancytree/amore/ui.fancytree.css");
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/layout/jquery.layout.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/jquery.form.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/qtip/jquery.qtip.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/fancytree/jquery.fancytree-all.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/jquery/fileupload/jquery.fileupload.min.js"));
					} else {
						_loadCSS(window.root_path + "/res/core/comm/css/core.comm.all.css");
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.jquery.plugin.all.min.js"));
					}
				}
				,"ep.core" : function() {
					if(_splinter) {
						_loadCSS(window.root_path + "/res/core/comm/css/core.comm.base.css");					
						_loadCSS(window.root_path + "/res/core/comm/css/core.comm.content.css");					
						_loadCSS(window.root_path + "/res/core/comm/css/core.comm.plugin.css");
						_loadCSS(window.root_path + "/res/core/comm/css/core.comm.organ.css");
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.jslib.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.core.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.core.plugin.min.js"));
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.core.ui.min.js"));
					} else {
						_lo.push(__cachecontrol(window.root_path + "/res/core/comm/js/ep.core.all.js")); 
					}
				}
			};
