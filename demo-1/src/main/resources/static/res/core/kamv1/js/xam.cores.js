...
(function (factory) {
    ...
    $.widget('_XAM.fileupload', {
        ...
        _validate : function(files){
            ...
            var _sf = 0;
            var _flist = [];
             $("#"+_XAM.args.filelistID).find("tr").each(function(i, v){
...
(function (factory) {
    ...
    $.widget('_XAM.fileupload', $._XAM.fileupload, {
        ...
        setDownDisplay : function(isHide){     	
            ...
            _XAM.loader.script(parent.scriptBasePath + "xam.jszip.js?open&ver=2.0.0.17").script(parent.scriptBasePath + "xam.download.zip.js?open&ver=2.0.0.17").wait(function(e){
