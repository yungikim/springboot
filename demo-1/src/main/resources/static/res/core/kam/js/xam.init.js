...
function iframeInit(o){
    ...
    $.getScript(parent.scriptBasePath+"xam.loader.js", function(){
        _XAM.loader.script(parent.scriptBasePath + "xam.cores.js?open&ver=2.0.0.37").script(parent.scriptBasePath + "xam.lang.js?open&ver=2.0.0.34").wait(function(){
            _XAM.args = { 
            ...
            $.when.apply(null, [
                $.ajax({ 
                    url : parent.basePath + "/language/i18n_" + _XAM.env.lang + ".json?open&ver=2.0.0.34",
