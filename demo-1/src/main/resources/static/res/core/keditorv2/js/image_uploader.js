...
ImageUploader.APPLET_CODEBASE = /*document.location.protocol + "//" + document.location.hostname + */"/res/core/keditor/";
ImageUploader.APPLET_CODE = "com.kmslab.imgctrl.ImageControl";
ImageUploader.APPLET_ARCHIVE = "ImageControl.1.1.0.6.amore.jar"; //ImageControl.1.1.0.6.amore.jar";
...
ImageUploader.deploy = function(){
	...
	if(window.deployJava && window.deployJava.runApplet && !ImageUploader.is_mobile){
		window.deployJava.runApplet(att, ImageUploader.PARAM, ImageUploader.APPLET_MINIMUM_VERSION);
	}else{
		var html = '';
