...
(function () {
    ...
    (function () {
        ...
        Object.extend(t, {
            ...
            gecko: e("firefox"), // || e("like gecko"),
            gecko_ver: e("firefox") ? parseFloat(x.replace(/.*firefox\/([\d\.]+).*/g, "$1")) : 0,
            msie: (x.indexOf("msie") != -1), // || e("trident"),
            msie11above: (e("trident") && w(/rv:\d+\.\d+/)),
            msie_ver: ! function () {
                if (!this.msie) {
                    return 0
                }
                return e("msie") ? parseFloat(navigator.appVersion.split("MSIE")[1]) : parseFloat(navigator.appVersion.split("rv:")[1])
            },
        ...
        t.msie6 = t.msie && 6 <= t.msie_ver && t.msie_ver < 7;
        Object.extend(t, {
    ...
    (function () {
        t.extend(t, {
            ...
            observe: function (y, x, w, e) {
                y = t(y);
                e = e || c;
                if (x == "keypress" && (t.webkit || y.attachEvent)) {
                    x = "keydown"
                }
            ...
            stopObserving: function (z, y, x, w) {
                z = t(z);
                w = w || c;
                if (y == "keypress" && (t.webkit || z.attachEvent)) {
                    y = "keydown"
                }
    ...
    d.typeOf = function (x) {
        ...
        if (w == "object") {
            if (x) {
                ...
                if ((e == "[object Array]" || typeof x.length == "number" && isTypeOfUndefined(x.splice) != q + "" && typeof x.propertyIsEnumerable != q + "" && !x.propertyIsEnumerable("splice"))) {
                    return "array"
                }
    ...
    d.userAgent.init_ = function () {
        ...
        if (!d.userAgent.BROWSER_KNOWN_ && (w = d.userAgent.getUserAgentString())) {
            ...
            d.userAgent.detectedOpera_ = w.indexOf("Opera") == 0;
            d.userAgent.detectedIe_ = !d.userAgent.detectedOpera_ && w.indexOf("MSIE") != -1;
            d.userAgent.detectedWebkit_ = !d.userAgent.detectedOpera_ && w.indexOf("WebKit") != -1;
            d.userAgent.detectedMobile_ = d.userAgent.detectedWebkit_ && w.indexOf("Mobile") != -1;
            d.userAgent.detectedGecko_ = !d.userAgent.detectedOpera_ && !d.userAgent.detectedWebkit_ && e.product == "Gecko"
        }
    };
    ...
    d.userAgent.isVersionCache_ = {};
    d.userAgent.isVersion = function (e) {
        return d.userAgent.isVersionCache_[e] || (d.userAgent.isVersionCache_[e] = d.string.compareVersions(d.userAgent.VERSION, e) >= 0)
    };
    d.userAgent.isDocumentModeCache_ = {};
    d.userAgent.isDocumentMode = function (e) {
        return d.userAgent.isDocumentModeCache_[e] || (d.userAgent.isDocumentModeCache_[e] = d.userAgent.IE && b.documentMode && b.documentMode >= e)
    };
    ...
    var p = function () {
        ...
        var E = {
            ...
            form: "tx_editor_form",
            txIconPath: "/res/core/keditor/images/icon/editor/",
            txDecoPath: "/res/core/keditor/images/deco/contents/",
            params: [],
            events: {
                preventUnload: u,
                useHotKey: u
        ...
        var x = {
            getUrl: function (I, J) {
                ...
                I = I.replace(/#host#path\/pages\//g, EditorJSLoader.getPageBasePath());
                I = I.replace(/#host/g, E.txHost);
                I = I.replace(/#path\/?/g, E.txPath);
                for (var G in B) {
                    I = I.replace(new RegExp("#".concat(G), "g"), E[B[G]])
                }
                if (J) {
                    for (var H in J) {
                        I = I.replace(new RegExp("#".concat(H), "g"), J[H])
                    }
                }
                return I
            },
    ...
    Object.extend(v, {
        EMPTY_PARAGRAPH_HTML: (t.msie ? "<p>&nbsp;</p>" : "<p><br></p>")
    });
    h.$tom = v;
    (function (e) {
        e.Util = {
        ...
        sendRequest: function (w, x, y, z, D, E) {
            ...
            try {
                ...
                if (w.toUpperCase() == "POST") {
                    ...
                    A.setRequestHeader("Content-Length", y.length);
                    A.setRequestHeader("Connetion", "close");
                    A.send(y)
                } else {
                    if (y && y.length > 0) {
                        x = x + ((x.indexOf("?") > -1) ? "&" : "?") + y
    ...
    j.addMsg({
        "@menu.pallete.revert":_i18n.PALLETE_REVERT,
        "@adoptor.label":_i18n.PALLETE_LABEL,
        "@adoptor.transparent":_i18n.PALLETE_TRANSPARENT
    });
    ...
    j.addMsg({
        "@menu.pallete.enter": _i18n.PALLETE_ENTER,
        "@menu.pallete.more": _i18n.PALLETE_MORE
    });
        ...
        h.Editor = g.Class.create({
            ...
            initialize: function (x) {
                ...
                try {
                    ...
                    z = new g.Editor(x);
                    var A = z.getInitializedId();
                    if (A != i) {
						//INotes에서 제공하는 ID
                        var w = A == "" ? 0 : parseInt(A.rightBack("-"));	
                        Editor.__MULTI_LIST[w] = z;
                        Editor.__SELECTED_INDEX = w;
                    }
                    Object.extend(Editor, z);
                    Editor.__EDITOR_LOADED = u;
                    Editor.__ACTIVE = u
                } catch (y) {
                    if (z) {
                        z.fireJobs(g.Ev.__RUNTIME_EXCEPTION, y)
                    } else {
                        throw "failed to initialize editor. caused by " + y
                    }
                    throw y
                }
            }
    ...
    g.Save = g.Class.create({
        ...
        load: function (w) {
            ...
            try {
                ...
                alert(" - Error: " + e.message + _i18n.LOAD_ERROR1);
    ...
    (function () {
        ...
        g.History.prototype = {
            ...
            getTextHandler: function () {
                ...
                var y = this.canvas;
                return function (z) {
                    y.setContent(z.content);
                    setTimeout(function () {
                        y.setScrollTop(z.scrollTop)
                    }, 0)
                }
            },
    ...
    (function (w) {
        ...
        p.add({
            ...
            B.wysiwygUrl = p.getUrl([B.wysiwygPath, "wysiwyg_", (B.serviceWysiwyg || ""), ((B.doctype == "html") ? "html" : "xhtml"), ".", (B.ext ? B.ext : "html"), "?prefix=" + z.initializedId, "&", B.param].join(""))
        });
        p.add({
            size: {}
        });
        w.Canvas = w.Class.create({
            ...
            changeMode: function (z) {
                ...
                try {
                    ...
                    alert(" - Error: " + G.message + _i18n.TYPE_ERROR);
                    A.setContent(F);
                    A.show();
                    return
                }
            ...
            onKeyDown: function (y) {
                this.fireJobs(w.Ev.__CANVAS_PANEL_KEYDOWN, y);
    ...
    (function () {
        ...
        var e = '<html lang="ko"><head><meta http-equiv="X-UA-Compatible" content="IE=10" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>K-Portal Web Editor</title><script id="txScriptForEval"><\/script><link rel="stylesheet" href="' + w + 'content_view.css" type="text/css"></link><link rel="stylesheet" href="' + w + 'content_wysiwyg.css" type="text/css"></link><style id="txStyleForSetRule"></style>'
+ '</head><body class="tx-content-container" style="font-family:' + _i18n.FONTFAMILY_1 + ';">' + v.EMPTY_PARAGRAPH_HTML + "</body></html>"
    })();
    (function () {
    ...
    (function () {
        ...
        var e = function (y, z) {
            var B = 0,
                C = -1,
                A = (t.msie || t.webkit) ? "keydown" : "keypress";
        ...
        g.Canvas.WysiwygPanel = g.Class.create({
            ...
            initialize: function (A, B) {
                ...
                C.load(function (F) {
                    ...
                    //z.clearContent(); /*** 내용이 먼저들어가는 경우가 있음 ***/
                    z.bindEvents(A);
    ...
    g.Canvas.Marker = g.Class.create({
        $mixins: [((t.msie) ? g.I.Marker.Trident : g.I.Marker.Standard)],
        initialize: function (e) {
            this.processor = e
        },
        backup: function () {
    ...
    g.Canvas.Selection = g.Class.create({
        $mixins: [g.I.Selection.Standard, ((t.msie) ? g.I.Selection.Trident : {}), ((t.gecko) ? g.I.Selection.Gecko : {}), ((t.webkit) ? g.I.Selection.Webkit : {}), ((t.presto) ? g.I.Selection.Presto : {})],
        initialize: function (e) {
            this.processor = e;
            this.win = e.win;
            this.doc = e.doc
    ...
    g.Canvas.TextAreaProcessor = g.Class.create({
        ...
        savePosition: function () {
            if (this.el.createTextRange) {
                this.currentPos = b.selection.createRange().duplicate()
            }
        },
    ...
    g.I.Processor.Standard = {
            ...
            if (x.style && x.style[w]) {
                ...
                if (x.currentStyle && x.currentStyle[w]) {
                    ...
                    if (h.getComputedStyle) {
                        var e = this.doc.defaultView.getComputedStyle(x, i);
                        return ((e) ? e[w] : i)
                    }
                }
            }
        ...
        pasteNode: function (z, y, B) {
            ...
            if (y) {
                var x, w, e;
                var A = this;
                this.execWithMarker(function (C) {
                    e = v.divideParagraph(C.endMarker);
                    var D = v.kindOf(e, "p,li,dd,dt,h1,h2,h3,h4,h5,h6");
                    if (D) {
                        x = v.previous(e);
                        w = v.clone(e)
                    } else {
                        e = A.newNode("p");
                        v.insertAt(e, C.endMarker);
                        w = A.newNode("p")
                    }
                    v.insertAt(w, e);
                    z.each(function (E) {
    ...
    (function () {
        var e = g.Class.create({
            ...
            find: function (A) {
                ...
                while (z) {
                    y = z;
                    if (v.isBody(z) || v.kindOf(z, "%tablegroup")) {
                        break
                    }
    ...
    g.Canvas.Processor = g.Class.draft({
        $mixins: [g.I.Processor.Standard, ((t.msie) ? g.I.Processor.Trident : {}), ((t.gecko) ? g.I.Processor.Gecko : {}), ((t.webkit) ? g.I.Processor.Webkit : {}), ((t.presto) ? g.I.Processor.Presto : {})]
    });
    g.Canvas.ProcessorP = g.Class.create({
        $extend: g.Canvas.Processor,
        $mixins: [g.I.Processor.StandardP, ((t.msie) ? g.I.Processor.TridentP : {}), ((t.gecko) ? g.I.Processor.GeckoP : {}), ((t.webkit) ? g.I.Processor.WebkitP : {}), ((t.presto) ? g.I.Processor.PrestoP : {})]
    });
    g.register("filter > mode change", function (D, E, e, y, A) {
        function x(I) {
            var J = [
        ...
        function C(G) {
            try {
                return G.replace(new RegExp("<br[^>]*>\\n", "gi"), "\n")
            } catch (H) {}
            return G
        }
        ...
        function z(G) {
            return G.replace(/<\/(p)><(p[\s>])/gi, "</$1>\n<$2")
        }

        function F(G) {
            return G.replace(/<\/(p)>\n+<(p[\s>])/gi, "</$1><$2")
        }
        var w = D.getDocParser();
        w.registerFilter("filter/converting", {
            "text@load": function (G) {
                return x(G)
            },
            "source@load": function (G) {
                return G
            },
            "html@load": function (G) {
                return G
            },
            text4save: function (H) {
                var G;
            ...
            source4save: function (G) {
                return G
            },
            html4save: function (G) {
                return G
            },
            text2source: function (G) {
                return B(G)
            },
            text2html: function (G) {
                return B(G)
            },
            source2text: function (G) {
                return x(F(G))
            },
            source2html: function (G) {
                return F(G)
            },
            html2text: function (G) {
                return x(G)
            },
            html2source: function (G) {
                return z(G)
            }
        })
    });
    ...
    j.addMsg({
        "@attacher.only.wysiwyg.alert": _i18n.ONLY_WYSIWYG_ALERT
    });
    ...
    j.addMsg({
        "@embeder.alert":_i18n.EMBEDER_ALERT
    });
    ...
    j.addMsg({
        "@switcher.wysiwyg": _i18n.SWITCHER_WYSIWYG,
        "@switcher.source": "HTML",
        "@switcher.text": _i18n.SWITCHER_TEXT
    });
    p.addTool("switcher", {
        wysiwygonly: c,
        status: u,
    ...
    p.addTool("switchertoggle", {
        ...
        status: u,
        options: [{
            label: _i18n.SWITCHER_WYSIWYG,
            title: _i18n.SWITCHER_WYSIWYG,
            data: "html"
        }, {
            label: "HTML",
            title: "HTML",
    ...
    var tmp = {};
    tmp["@fontfamily." + _i18n.FONTID_1] = _i18n.FONTNAME_1;
    tmp["@fontfamily." + _i18n.FONTID_2] = _i18n.FONTNAME_2;
    tmp["@fontfamily." + _i18n.FONTID_3] = _i18n.FONTNAME_3;
	tmp["@fontfamily." + _i18n.FONTID_4] = _i18n.FONTNAME_4;
	tmp["@fontfamily." + _i18n.FONTID_5] = _i18n.FONTNAME_5;
	tmp["@fontfamily." + _i18n.FONTID_6] = _i18n.FONTNAME_6;
	tmp["@fontfamily." + _i18n.FONTID_7] = _i18n.FONTNAME_7;
	tmp["@fontfamily." + _i18n.FONTID_8] = _i18n.FONTNAME_8;
	tmp["@fontfamily." + _i18n.FONTID_9] = _i18n.FONTNAME_9;
	tmp["@fontfamily." + _i18n.FONTID_10] = _i18n.FONTNAME_10;
	tmp["@fontfamily." + _i18n.FONTID_11] = _i18n.FONTNAME_11;
	tmp["@fontfamily." + _i18n.FONTID_12] = _i18n.FONTNAME_12;
	tmp["@fontfamily." + _i18n.FONTID_13] = _i18n.FONTNAME_13;
	tmp["@fontfamily." + _i18n.FONTID_14] = _i18n.FONTNAME_14;
	tmp["@fontfamily." + _i18n.FONTID_15] = _i18n.FONTNAME_15;
...
*/
    p.addTool("fontfamily", {
        ...
        options: [
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_1),
		title: TXMSG("@fontfamily." + _i18n.FONTID_1),
		data: _i18n.FONTFAMILY_1,
		klass: "tx-editor-font-1"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_2),
		title: TXMSG("@fontfamily." + _i18n.FONTID_2),
		data: _i18n.FONTFAMILY_2,
		klass: "tx-editor-font-2"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_3),
		title: TXMSG("@fontfamily." + _i18n.FONTID_3),
		data: _i18n.FONTFAMILY_3,
		klass: "tx-editor-font-3"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_4),
		title: TXMSG("@fontfamily." + _i18n.FONTID_4),
		data: _i18n.FONTFAMILY_4,
		klass: "tx-editor-font-4"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_5),
		title: TXMSG("@fontfamily." + _i18n.FONTID_5),
		data: _i18n.FONTFAMILY_5,
		klass: "tx-editor-font-5"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_6),
		title: TXMSG("@fontfamily." + _i18n.FONTID_6),
		data: _i18n.FONTFAMILY_6,
		klass: "tx-editor-font-6"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_7),
		title: TXMSG("@fontfamily." + _i18n.FONTID_7),
		data: _i18n.FONTFAMILY_7,
		klass: "tx-editor-font-7"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_8),
		title: TXMSG("@fontfamily." + _i18n.FONTID_8),
		data: _i18n.FONTFAMILY_8,
		klass: "tx-editor-font-8"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_9),
		title: TXMSG("@fontfamily." + _i18n.FONTID_9),
		data: _i18n.FONTFAMILY_9,
		klass: "tx-editor-font-9"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_10),
		title: TXMSG("@fontfamily." + _i18n.FONTID_10),
		data: _i18n.FONTFAMILY_10,
		klass: "tx-editor-font-10"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_11),
		title: TXMSG("@fontfamily." + _i18n.FONTID_11),
		data: _i18n.FONTFAMILY_11,
		klass: "tx-editor-font-11"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_12),
		title: TXMSG("@fontfamily." + _i18n.FONTID_12),
		data: _i18n.FONTFAMILY_12,
		klass: "tx-editor-font-12"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_13),
		title: TXMSG("@fontfamily." + _i18n.FONTID_13),
		data: _i18n.FONTFAMILY_13,
		klass: "tx-editor-font-13"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_14),
		title: TXMSG("@fontfamily." + _i18n.FONTID_14),
		data: _i18n.FONTFAMILY_14,
		klass: "tx-editor-font-14"
},
{
		label: TXMSG("@fontfamily." + _i18n.FONTID_15),
		title: TXMSG("@fontfamily." + _i18n.FONTID_15),
		data: _i18n.FONTFAMILY_15,
		klass: "tx-editor-font-15"
}
	]
    });
...
*/
    ...
    g.Tool.Bold = g.Class.create({
        ...
        $extend: g.Tool,
        $mixins: [g.I.FontTool, g.I.ButtonFontTool],
        getRelatedCssPropertyNames: function () {
            return ["font", this.getCssPropertyName()]
        },
        getCssPropertyName: function () {
    ...
    p.addTool("insertcells", {
        ...
        status: u,
        options: [{
            label: _i18n.CELL_ADDROWUPPER,
            title: _i18n.CELL_ADDROWUPPER,
            data: "addRowUpper",
            klass: "tx-insertcells-1"
        }, {
            label: _i18n.CELL_ADDROWBELOW,
            title: _i18n.CELL_ADDROWBELOW,
            data: "addRowBelow",
            klass: "tx-insertcells-2"
        }, {
            label: _i18n.CELL_ADDCOLLEFT,
            title: _i18n.CELL_ADDCOLLEFT,
            data: "addColLeft",
            klass: "tx-insertcells-3"
        }, {
            label:_i18n.CELL_ADDCOLRIGHT,
            title:_i18n.CELL_ADDCOLRIGHT,
            data: "addColRight",
    ...
    p.addTool("deletecells", {
        ...
        status: u,
        options: [{
            label: _i18n.CELL_DELETEROW,
            title: _i18n.CELL_DELETEROW,
            data: "deleteRow",
            klass: "tx-deletecells-1"
        }, {
            label: _i18n.CELL_DELETECOL,
            title: _i18n.CELL_DELETECOL,
            data: "deleteCol",
    ...
    p.addTool("mergecells", {
        ...
        status: u,
        options: [{
            label: _i18n.CELL_MERGE,
            title: _i18n.CELL_MERGE,
            data: "merge",
            klass: "tx-mergecells-1"
        }, {
            label: _i18n.CELL_CANCELMERGE,
            title: _i18n.CELL_CANCELMERGE,
            data: "cancelmerge",
    ...
    j.addMsg({
        "@cellslinestyle.subtitle1": _i18n.CELL_LINESTYLE_1,
        "@cellslinestyle.subtitle2": _i18n.CELL_LINESTYLE_2,
        "@cellslinestyle.subtitle3": _i18n.CELL_LINESTYLE_3,
        "@cellslinestyle.subtitle4": _i18n.CELL_LINESTYLE_4
    });
    ...
    p.addTool("cellsoutline", {
        ...
        status: u,
        options: [{
            label: _i18n.CELL_OUTLINE_ALL,
            title: _i18n.CELL_OUTLINE_ALL,
            data: "all",
            klass: "tx-cellsoutline-1"
        }, {
            label:_i18n.CELL_OUTLINE_OUT,
            title: _i18n.CELL_OUTLINE_OUT,
            data: "out",
            klass: "tx-cellsoutline-2"
        }, {
            label: _i18n.CELL_OUTLINE_IN,
            title: _i18n.CELL_OUTLINE_IN,
            data: "in",
            klass: "tx-cellsoutline-3"
        }, {
            label: _i18n.CELL_OUTLINE_TOP,
            title: _i18n.CELL_OUTLINE_TOP,
            data: "top",
            klass: "tx-cellsoutline-4"
        }, {
            label: _i18n.CELL_OUTLINE_BOTTOM,
            title: _i18n.CELL_OUTLINE_BOTTOM,
            data: "bottom",
            klass: "tx-cellsoutline-5"
        }, {
            label: _i18n.CELL_OUTLINE_LEFT,
            title: _i18n.CELL_OUTLINE_LEFT,
            data: "left",
            klass: "tx-cellsoutline-6"
        }, {
            label: _i18n.CELL_OUTLINE_RIGHT,
            title: _i18n.CELL_OUTLINE_RIGHT,
            data: "right",
            klass: "tx-cellsoutline-7"
        }, {
            label: _i18n.CELL_OUTLINE_NONE,
            title: _i18n.CELL_OUTLINE_NONE,
            data: "none",
    ...
    j.addMsg({
        "@styledlist.subtitle1": _i18n.STYLEDLIST_1,
        "@styledlist.subtitle2": _i18n.STYLEDLIST_2,
        "@styledlist.subtitle3": _i18n.STYLEDLIST_3,
        "@styledlist.subtitle4": _i18n.STYLEDLIST_4,
        "@styledlist.subtitle5": _i18n.STYLEDLIST_5,
        "@styledlist.subtitle6": _i18n.STYLEDLIST_6
    });
    ...
    j.addMsg({
        "@insertlink.cancel.image": "#iconpath/" + _i18n.IMG_BTN_CANCEL + "?v=2",
        "@insertlink.confirm.image": "#iconpath/" + _i18n.IMG_BTN_CONFIRM + "?v=2",
        "@insertlink.invalid.url": _i18n.INSERT_LINK_INVALID_URL,
        "@insertlink.link.alt": _i18n.INSERT_LINK_LINK_ALT,
        "@insertlink.remove.image": "#iconpath/" + _i18n.IMG_BTN_REMOVE + "?v=2",
        "@insertlink.title": _i18n.INSERT_LINK_TITLE,
        "@insertlink.onclick.target": _i18n.INSERT_CLICK_TARGET,
        "@insertlink.target.blank": _i18n.INSERT_TARGET_BLANK,
        "@insertlink.target.self": _i18n.INSERT_TARGET_SELF,
    ...
    j.addMsg({
        "@richtextbox.add": _i18n.RICH_ADD,
        "@richtextbox.sub": _i18n.RICH_SUB,
        "@richtextbox.alert": _i18n.RICH_ALERT,
        "@richtextbox.bg.color": _i18n.RICH_BGCOLOR,
        "@richtextbox.border.color": _i18n.RICH_BORDERCOLOR,
        "@richtextbox.border.style": _i18n.RICH_BORDERSTYLE,
        "@richtextbox.border.width":_i18n.RICH_BORDERWIDTH
    });
    g.Tool.RichTextBox = g.Class.create({
        ...
        oninitialized: function () {
            ...
            var x = this.handler = function () {
                var A = e.menu;
                var z = {
                    borderStyle: A.elPreview.style.borderStyle,
                    borderWidth: A.elPreview.style.borderWidth,
                    borderColor: A.elPreview.style.borderColor,
                    backgroundColor: A.elPreview.style.backgroundColor,
                    padding: A.padding
                };
                y.execute(function (C) {
                    var D = C.blocks(function () {
                    ...
                    w.fireJobs("cmd.textbox.added", B)
                })
            };
    ...
    g.Menu.RichTextbox = g.Class.create({
        ...
        createColorPallete: function (e, x) {
            var w = new g.Menu.ColorPallete({
                el: e,
    ...
    p.addTool("quote", {
        ...
        options: [{
            type: "image",
            data: "tx-quote1",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_01 + "?v=2"
        }, {
            type: "image",
            data: "tx-quote2",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_02 + "?v=2"
        }, {
            type: "image",
            data: "tx-quote3",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_03 + "?v=2"
        }, {
            type: "image",
            data: "tx-quote4",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_04 + "?v=2"
        }, {
            type: "image",
            data: "tx-quote5",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_05 + "?v=2"
        }, {
            type: "cancel",
            data: "tx-quote6",
            image: "#iconpath/quote/" + _i18n.TOOLBAR_IMG_QUOTE_06 + "?v=2"
        }]
    }, function (e) {
    ...
    g.Tool.Table = g.Class.create({
        ...
        makeEmptyTable: function (E, e) {
            var D = [];
            var B = this._createDefaultTableWidth();
            D.push('<table class="' + g.Tool.Table.__DEFAULT_TABLE_CLASS + '" width="' + B + '" ');
            D.push(g.Tool.Table.__DEFAULT_TABLE_PROPERTY_STR);
            D.push(' style="');
            D.push(g.Tool.Table.__DEFAULT_TABLE_STYLE);
            D.push(";font-family:");
            D.push(this.editor.canvas.getStyle("fontFamily"));
            D.push(";font-size:");
            D.push(this.editor.canvas.getStyle("fontSize"));
            D.push('"><tbody>');
            var C = this.config.borderStyle;
            var A = parseInt(B / e);
            var w = ["border-bottom:", C, ";border-right:", C, ";"].join("");
            for (var z = 0; z < E; z++) {
                D.push("<tr>");
                for (var y = 0; y < e; y++) {
                    var x = [w];
                    D.push('<td style="width:');
                    D.push(A);
                    D.push(";");
                    D.push("height:", 24, ";");
                    D.push(w);
    ...
    j.addMsg({
        "@table.title.insert": _i18n.TABLE_TITLE_INSERT,
        "@table.title.setDirectly": _i18n.TABLE_TITLE_SETDIRECTLY,
        "@table.title.row": _i18n.TABLE_TITLE_ROW,
        "@table.title.col": _i18n.TABLE_TITLE_COL
    });
    ...
    g.Tool.Paste = g.Class.create({
        ...
        oninitialized: function () {
            ...
            var e = function () {
                w.getProcessor().blur();
                w.focus();
                w.execute(function (C) {
					try {
						var iframewin = document.getElementById('tx_canvas_wysiwyg').contentWindow;
						_imageControl.editorPasteControl(e, iframewin.document);
					} catch (y) {
					}
                });
            };
    ...
    p.addTool("dictionary", {
        url: "http://dictionary.kmslab.com",
        sync: c,
        status: c
    });
    g.Tool.Dictionary = g.Class.create({
        ...
        oninitialized: function (e) {
            ...
            var w = function () {
                ...
                var y = (A.length > 0) ? "http://dictionary.kmslab.com" : e.url;
    ...
    (function () {
        g.Embeder.Media = g.Class.create({
            ...
            canResized: u,
            getCreatedHtml: function (F) {
                var E = F.code || e(F.url, this.config);
                return A(E)
            },
            getDataForEntry: function () {}
        });
        g.register("filter > media ", function (E, F, H) {
            var G = H.embeders.media.config;
            E.getDocParser().registerFilter("filter/embeder/media", {
                "text@load": function (I) {
                    return I
                },
                "source@load": function (I) {
                    return A(I)
                },
                "html@load": function (I) {
                    return A(I)
                },
                text4save: function (I) {
                    return I
                },
                source4save: function (I) {
                    I = C(I);
                    I = y(I, G);
                    return I
                },
                html4save: function (I) {
                    I = C(I);
                    I = y(I, G);
                    return I
                },
                text2source: function (I) {
                    return I
                },
                text2html: function (I) {
                    return I
                },
                source2text: function (I) {
                    return I
                },
                source2html: function (I) {
                    return A(I)
                },
                html2text: function (I) {
                    return C(I)
                },
                html2source: function (I) {
                    return C(I)
                }
            })
        });
        ...
        function z(H, G) {
            ...
            E = G.allowNetworkingSites.length;
            for (I = 0; I < E; I += 1) {
                if (J == G.allowNetworkingSites[I].host) {
                    return u
                }
            }
            return c
        ...
        function y(G, F) {
            var E;
            if (F.allowNetworkingFilter == c) {
                return G
            }
            E = G.replace(/(<object[^>]*>)((?:\n|.)*?)(<\/object>)/gi, function (J, N, L, H) {
                var I, K;
                var M = c;
                I = /data[\s]*=[\s"']*(http:\/\/[^\/]+\/)[^("'\s)]+/i.exec(N);
                if (I && I.length == 2) {
                    K = I[1];
                    if (z(K, F) === c) {
                        M = u
                ...
                I = /<param[^>]*=[^\w]*movie[^\w]+[^>]*>/i.exec(L);
                if (I && I[0]) {
                    K = /\s+value=["']?([^\s"']*)["']?/i.exec(I[0]);
                    if (K && K[1]) {
                        if (z(K[1], F) === c) {
                            M = u
                        }
                ...
                if (M === u) {
                    L = L.replace(/<param[^>]*=[^\w]*allowNetworking[^\w]+[^>]*>/i, "");
                    L = '<param name="allowNetworking" value="internal" />'.concat(L)
                }
                return N + L + H
            });
            E = E.replace(/(<embed)([^>]*)(><\/embed>|\/>)/gi, function (K, L, H, I) {
                var J = /\s+src=["']?([^\s"']*)["']?/i.exec(H);
                if (J && J[1]) {
                    if (z(J[1], F)) {
                        return L + H + I
                    }
                }
                H = H.replace(/\s+allowNetworking=["']?[\w]*["']?/i, "").concat(' allowNetworking="internal"');
                return L + H + I
            });
            return E
        }
        ...
        function C(J) {
            var G;
            var I = new RegExp("<(?:img|IMG)[^>]*txc-media[^>]*/?>", "gim");
            var H = J;
            while ((G = I.exec(H)) != i) {
                var F = G[0];
                var E = w(F);
                if (!t.msie && E.indexOf("$") > -1) {
                    E = E.replace(/\$/g, "$$$$")
                }
                J = J.replace(F, E)
            }
        ...
        function A(L) {
            if (t.msie) {
                L = L.replace(/<iframe[^>]*src=("|'|)https?:\/\/www\.youtube\.com\/embed\/(\w+)\1[^>]*><\/iframe>/i, function (Q, P, O) {
                    var N, R, M;
                    N = Q.match(/\swidth=['"]?(\d+)/);
                    R = (N && N[1]) || "560";
                    N = Q.match(/\sheight=['"]?(\d+)/);
                    M = (N && N[1]) || "315";
                    return '<object width="' + R + '" height="' + M + '"><param name="movie" value="https://www.youtube.com/v/' + O + '?version=3&amp;hl=ko_KR"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><param name="wmode" value="transparent"></param><embed src="https://www.youtube.com/v/' + O + '?version=3&amp;hl=ko_KR" type="application/x-shockwave-flash" width="' + R + '" height="' + M + '" allowscriptaccess="always" allowfullscreen="true" wmode="transparent"></embed></object>'
                });
                L = L.replace(/(<object[^>]*>)((?:\n|.)*?)(<\/object>)/gi, function (N, P, O, M) {
                    O = O.replace(/<param[^>]*=[^\w]*wmode[^\w]+[^>]*>/i, "");
                    O = O.replace(/<param[^>]*=[^\w]*play[^\w]+[^>]*>/i, "");
                    O = '<param name="wmode" value="transparent" />'.concat(O);
                    return P + O + M
                });
                L = L.replace(/(<embed)([^>]*)(>)/gi, function (O, P, M, N) {
                    M = M.replace(/\s+wmode=("|'|)\w*\1/i, "");
                    M += " wmode=transparent";
                    return P + M + N
                });
                return L
                ...
                while ((H = F.exec(I)) != i) {
                    E = H[0];
                    G = E.replace(/<embed/i, "<xxembed");
                    L = L.replace(E, G)
                }
                var K = new RegExp("<(?:object|OBJECT)[^>]*>[\\S\\s]*?(<(?:embed|EMBED)[^>]*src=[^>]*>)[\\S\\s]*?</(?:object|OBJECT)>", "gim");
                while ((H = K.exec(I)) != i) {
                    E = H[0];
                    J = H[1];
                    G = D(E, J);
                ...
                K = new RegExp("<(?:embed|EMBED)[^>]*src=[^>]*(?:/?>|></(?:embed|EMBED)>)", "gim");
                while ((H = K.exec(I)) != i) {
                    E = H[0];
                    J = H[0];
                    G = D(E, J);
        ...
        function D(G, O) {
            var F = g.Util.getAllAttributesFromEmbed(O);
            var J = F.src;
            var K = (F.width || " ").parsePx();
            var L = (F.height || " ").parsePx();
            if (isNaN(K) || isNaN(L)) {
                var P = x(J);
                K = P.width;
                L = P.height
            ...
            var E = B(J);
            return '<img src="' + E.imageSrc + '" width="' + K + '" height="' + L + '" border="0" class="tx-entry-embed txc-media' + E.className + '" ld="' + encodeURIComponent(G) + '"/>'
        }

        function w(J) {
            var E = g.Util.getAllAttributes(J);
            var I = E.ld;
            if (!I || I.length == 0) {
                return ""
            }
            var G = E.width;
            var H = E.height;
            var K = decodeURIComponent(I);
            var N = K;
            if (K.indexOf("object") > -1 || K.indexOf("OBJECT") > -1) {
                var L;
                var O = new RegExp("<(?:embed|EMBED)[^>]*src=[^>]*(?:/?>|></(?:embed|EMBED)>)", "gim");
                while ((L = O.exec(K)) != i) {
                    N = L[0]
                }
            }
            E = g.Util.getAllAttributes(N);
            var F = E.src;
            var M = x(F);
            if (isNaN(G)) {
                K = g.String.changeAttribute(K, "width", G, M.width)
            } else {
                K = g.String.changeAttribute(K, "width", G, G)
            } if (isNaN(H)) {
                K = g.String.changeAttribute(K, "height", H, M.height)
            } else {
                K = g.String.changeAttribute(K, "height", H, H)
            }
            return K
        }
        ...
        function e(I, H) {
            var J, F, K, G, E;
            J = I.split(".").pop().split("?")[0].toLowerCase();
            F = x(I);

            K = " allowScriptAccess='never'";
            if (H.allowNetworkingFilter && z(I, H) == c) {
                K += " allowNetworking='internal'"
            }

            switch (J) {
            case "swf":
                return '<embed src="' + I + "\" quality='high' " + K + " type='application/x-shockwave-flash' allowfullscreen='true' pluginspage='http://www.macromedia.com/go/getflashplayer' wmode='transparent' width='" + F.width + "' height='" + F.height + "'></embed>";
            case "mp3":
            case "wma":
            case "asf":
            case "asx":
            ...
            case "wmv":
            case "avi":
                return '<embed src="' + I + '" type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/" width=\'' + F.width + "' height='" + F.height + "'></embed>";
            case "mov":
                return '<embed src="' + I + '" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/indext.html" width=\'' + F.width + "' height='" + F.height + "'></embed>";
            case "jpg":
            case "bmp":
            case "gif":
            case "png":
            ...
            default:
                return '<embed src="' + I + "\" width='" + F.width + "' height='" + F.height + "' " + K + " ></embed>"
            }
        }

        function x(F) {
            var E, G;
			var H = F.split(".").pop().split("?")[0].toLowerCase();
			switch (H) {
			case "mp3":
			case "wma":
			case "asf":
        ...
        function B(G) {
            var E = "";
            var F = "";
			var H = G.split(".").pop().split("?")[0].toLowerCase();
			switch (H) {
			case "mp3":
			case "wma":
			case "asf":
    ...
    j.addMsg({
        "@canvas.unload.message": _i18n.CANVAS_UNLOAD_MSG,
        "@canvas.unload.message.at.modify": _i18n.CANVAS_UNLOAD_MSG_AT_MODIFY
    });
    ...
    j.addMsg({
        "@align.image.align.center": _i18n.IMAGE_ALIGN_CENTER,
        "@align.image.align.full": _i18n.IMAGE_ALIGN_FULL,
        "@align.image.align.left": _i18n.IMAGE_ALIGN_LEFT,
        "@align.image.align.right": _i18n.IMAGE_ALIGN_RIGHT,
        "@align.text.align.center": _i18n.TEXT_ALIGN_CENTER,
        "@align.text.align.full": _i18n.TEXT_ALIGN_FULL,
        "@align.text.align.left": _i18n.TEXT_ALIGN_LEFT,
        "@align.text.align.right": _i18n.TEXT_ALIGN_RIGHT
    });
    ...
    j.addMsg({
        "@table.noselect.alert": _i18n.TABLE_NOSELECT_ALERT
    });
    g.Table = {};
...
//          t.observe(h.top, "mouseup", function (w) {
            t.observe(h.parent, "mouseup", function (w) {
                e.onmouseup()
            });
    ...
    g.Table.Merge = g.Class.create({
        ...
        merge: function (x) {
            var w, y, e;
            x.reloadIndexer();
            w = x.getSelectedTdArr();
            if (1 < w.length) {
                e = x.getSizeOfSelected();
                y = w[0];
                this.deleteCellForMerge(w);
                this.extendCellForMerge(y, x, e);
                x.reset();
                x.selectByTd(y, y);
                g.TableUtil.collapseCaret(this.wysiwygPanel, y)
            } else {
                alert(_i18n.TABLE_MERGE_ALERT)
            }
        },
        ...
        resetMerge: function (x) {
            ...
            e = this.splitRow(x);
            if (w === c && e === c) {
                alert(_i18n.TABLE_RESETMERGE_ALERT)
            } else {
                x.reloadIndexer()
            }
        },
    ...
    g.module("table resize dragger", function (w, x, y, e) {
        e.observeJob(g.Ev.__IFRAME_LOAD_COMPLETE, function () {
            ...
            var aG = 20;
            var aA;
            var aO = v.collect(e.wysiwygEl, ".tx-table-col-resize-dragger");
            var aM = v.collect(e.wysiwygEl, ".tx-table-row-resize-dragger");
            var Z = c;
            var aL, Y, au, aq;
            var aK, aP, aJ;
            var ao, Q, P;
            ...
            var ax = function () {
                var aR = new g.TableUtil.Indexer(aL);
                var aQ = aR.getBoundary(aB);
                if (aQ.left > 0) {
                    S = aR.getTdArrHasRight(aQ.left - 1);
                    az = aR.getTdArrHasLeft(aQ.left)
                }
            };
            var aF = function () {
                var aR = new g.TableUtil.Indexer(aL);
                var aQ = aR.getBoundary(aB);
                var aS = aR.getColSize();
                S = aR.getTdArrHasRight(aQ.right);
                if (aQ.right < aS - 1) {
                    az = aR.getTdArrHasLeft(aQ.right + 1)
                }
            };
            var M = function () {
                var aR = new g.TableUtil.Indexer(aL);
                var aQ = aR.getBoundary(aB);
                aE = aR.getTdArrHasBottom(aQ.top - 1)
            };
            var F = function () {
                var aR = new g.TableUtil.Indexer(aL);
                var aQ = aR.getBoundary(aB);
                aE = aR.getTdArrHasTop(aQ.bottom)
            };
            var at = function () {
                switch (ae) {
                case aI.LEFT:
            ...
            var aa = function () {
                var aR = v.find(t.element(aH), "td");
                var aQ = v.find(aR, ".txc-info");
                if (aR && !aQ) {
                    aB = aR;
                    ae = T(aB);
                    D()
            ...
            var ai = function () {
                ...
                var aQ = 0;
                if (S) {
                    for (aQ = 0; aQ < S.length; aQ++) {
                        aj.push(S[aQ].offsetWidth)
                    }
                    aK = aN(aj);
                    for (aQ = 0; aQ < S.length; aQ++) {
                        if (aK == aj[aQ]) {
                ...
                if (az) {
                    for (aQ = 0; aQ < az.length; aQ++) {
                        K.push(az[aQ].offsetWidth)
                    }
                    aP = aN(K);
                    for (aQ = 0; aQ < az.length; aQ++) {
                        if (aP == K[aQ]) {
            ...
            var am = function () {
                if (Z) {
                    var aQ = parseInt(W - v.getScrollLeft(I) - Q);
                    var aR;
                    if (au && aq) {
                        aR = B(au, aQ)
                    }
            ...
            var B = function (aS, aR) {
                ...
                if (aV >= aG && aQ >= aG) {
                    aW = W - v.getScrollLeft(I)
                } else {
                    if (aV <= aG) {
                        aV = aG;
                        aQ = aU - aV;
                        aW = aT.left - v.getScrollLeft(I) + aV
                    } else {
                        if (aQ <= aG) {
                            aQ = aG;
                            aV = aU - aQ;
            ...
            var al = function (aR, aQ) {
                var aT, aS, aU;
                aT = aK + aQ;
                aS = t.getCoordsTarget(aR);
                if (aT < aG) {
                    aT = aG
                }
                aU = aS.left - v.getScrollLeft(I) + aT;
                E = aT - aK;
                return aU
            };
            var aw = function (aT, aR) {
                var aQ, aS, aU;
                aQ = aP - aR;
                aS = t.getCoordsTarget(aT);
                if (aQ < aG) {
                    aQ = aG
                }
                aU = aS.left + aQ;
            ...
            var J = function () {
                ...
                if (S) {
                    for (aQ = 0; aQ < S.length; aQ++) {
                        S[aQ].style.width = aj[aQ] + E
                    }
                }
                if (az) {
                    for (aQ = 0; aQ < az.length; aQ++) {
                        az[aQ].style.width = K[aQ] - E
                    }
                }
                if (S && az == i) {
                    N()
            ...
            var ay = function () {
                ...
                if (aE) {
                    var aQ;
                    for (aQ = 0; aQ < aE.length; aQ++) {
                        ab.push(parseInt(aE[aQ].offsetHeight))
                    }
                    aJ = aN(ab);
                    for (aQ = 0; aQ < aE.length; aQ++) {
                        if (aJ == ab[aQ]) {
            ...
            var aC = function () {
                if (Z) {
                    var aQ = V - v.getScrollTop(I) - P;
                    var aR = aJ + parseInt(aQ);
                    var aS = t.getCoordsTarget(Y);
                    var aT = i;
                    if (aR < 0) {
                        aR = 0;
                        aT = aS.top + aR - v.getScrollTop(I)
                    } else {
                        aT = V - v.getScrollTop(I)
                    } if (aT) {
                        t.setStyle(z, {
                            top: aT.toPx()
                        })
            ...
            var ad = function () {
                if (aE) {
                    for (var aR = 0; aR < aE.length; aR++) {
                        var aQ = ab[aR] + C;
                        if (aQ < 0) {
                            aQ = 20
                        }
                        aE[aR].style.height = aQ.toPx()
                    }
                }
            };
            (function U() {
                var aQ = I.createElement("div");
                ac.appendChild(aQ);
            ...
            var T = function (aT) {
                ...
                if ("getBoundingClientRect" in document.documentElement) {
                    try {
                        var a3 = aT.ownerDocument,
                            aR = a3.documentElement,
                            aX = a3.body;
                        var aW = aT.getBoundingClientRect(),
                            aY = a3.defaultView || a3.parentWindow,
                            aV = aR.clientTop || aX.clientTop || 0,
                            a0 = aR.clientLeft || aX.clientLeft || 0,
                            aQ = aY.pageYOffset || aA && aR.scrollTop || aX.scrollTop,
                            aU = aY.pageXOffset || aA && aR.scrollLeft || aX.scrollLeft,
                            a1 = aW.top + aQ - aV,
                            aS = aW.left + aU - a0;
                        a2 = {
                            top: a1,
                            left: aS,
                            bottom: a1 + aT.offsetHeight,
                            right: aS + aT.offsetWidth
                        }
                    } catch (aZ) {
                        a2 = i
                    }
                ...
                if (!a2) {
                    a2 = t.getCoordsTarget(aT)
                }
                if ((W - a2.left) < 5 && aT.cellIndex != 0) {
                    a4 = aI.LEFT
                } else {
                    if ((a2.right - 5) < W) {
                        a4 = aI.RIGHT
                    } else {
                        if ((V - a2.top) < 5 && aT.parentNode.rowIndex != 0) {
                            a4 = aI.TOP
                        } else {
                            if ((a2.bottom - 5) < V) {
                                a4 = aI.BOTTOM
            ...
            var D = function () {
                e.query(function (aQ) {
                    if (aQ.table) {
                        if (aQ.table.isDuringSelection() || e.config.readonly) {
                            ae = aI.NONE
                        }
                        switch (ae) {
                        case aI.LEFT:
            ...
            var ag = function (aR) {
                ...
                var aQ;
                if (Z) {
                    aQ = t.getCoordsTarget(aR).left;
                    t.setStyle(aR, {
                        width: "2px",
                        height: X.el.clientHeight,
            ...
            var N = function () {
                ...
                if (ao) {
                    aQ = parseInt(ao) + E;
                    aL.width = aQ;
                    aL.style.width = aQ.toPx()
                }
            };
            var A = function () {
                t.observe(b.body, "mouseup", function (aQ) {
                    av(aQ);
                    at()
                });
                if (t.msie) {
                    t.observe(ac, "mousemove", function (aQ) {
                        av(aQ);
                        R()
                    });
                    t.observe(ac, "mouseup", function (aQ) {
                        av(aQ);
                        at()
                    })
                } else {
                    t.observe(aD, "mousemove", function (aQ) {
                        av(aQ);
                        R()
                    });
                    t.observe(aD, "mouseup", function (aQ) {
                        av(aQ);
                        at()
                    })
                } if (t.safari) {
                    t.observe(b.body, "mousemove", function (aQ) {
                        if (Z) {
                            ak(aQ);
                            R()
                        }
                ...
                t.observe(aO, "mousedown", function (aQ) {
                    av(aQ);
                    ah()
                });
                t.observe(aM, "mousedown", function (aQ) {
                    av(aQ);
                    ah()
                })
            };
            ...
            var ak = function (aQ) {
                aH = aQ;
                W = ap(aH) - t.getCoords(e.wysiwygEl).left + I.body.scrollLeft;
                V = an(aH) - t.getCoords(e.wysiwygEl).top + I.body.scrollTop
            };
            var ap = function (aR) {
                var aQ = 0;
                aR = aR || aD.event;
                if (aR.pageX) {
                    ...
                    if (aR.clientX) {
                        aQ = aR.clientX + I.body.scrollLeft + I.documentElement.scrollLeft
                    }
                }
                return aQ
            };
            var an = function (aQ) {
                ...
                if (aQ.pageY) {
                    ...
                    if (aQ.clientY) {
                        aR = aQ.clientY + I.body.scrollTop + I.documentElement.scrollTop
                    }
                }
                return aR
            };
