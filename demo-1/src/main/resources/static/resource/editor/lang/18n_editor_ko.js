...
{ label: '<span f-style>LG스마트체 Bold</span> (<span class="tx-txt">가나다라</span>)', title: 'LG스마트체 Bold', data: "'LG스마트체 Bold'", klass: '' },
{ label: '<span f-style>LG스마트체 Light</span> (<span class="tx-txt">가나다라</span>)', title: 'LG스마트체 Light', data: "'LG스마트체 Light'", klass: '' },
{ label: '<span f-style>LG스마트체 Regular</span> (<span class="tx-txt">가나다라</span>)', title: 'LG스마트체 Regular', data: "'LG스마트체 Regular'", klass: '' },
{ label: '<span f-style>LG스마트체 SemiBold</span> (<span class="tx-txt">가나다라</span>)', title: 'LG스마트체 SemiBold', data: "'LG스마트체 SemiBold'", klass: '' },
