/*
	gptpt.send_ai_request("미확인 메일 요약해줘") //모바일 웹에서 테스트 방법
*/
	...
	$.ajax({
		...
		"success" : function(res){
			...
			//	location.href = root_path + "/index.jsp";
				...
				//메인 페이지로 이동한다.
				location.href = root_path + "/page/kgpt_mobile.jsp";
			}else{
				...
				html += "<div id='guide_login_fail' class='login_fail'>계정 혹은 비밀번호가 일치하지 않습니다. 입력한 내용을 다시 확인해 주세요</div>";
				/// 로그인 실패 안내 문구 표시
