...
gFilesFN.prototype = {
	...
	"draw_files_home" : function(){
		var html = "";
		
		html += "<div id='files_home_container'>";
		html += "	<div class='inner_wrap'>";
		html += "		<div class='inner'>";
		html += "			<div id='files_home_search_nav' class='search_nav' style='display: none;'>";
		html += "				<div class='search_area'>";
		html += "					<input type='text' id='input_files_search_home' class='files_search_home_input' placeholder='원하는 파일을 찾아보세요.' autocomplete='off' spellcheck='false'>";
		html += "					<button type='button' id='btn_files_home_search' class='ico_home_search_files'></button>";
		html += "					<button type='button' id='btn_files_home_search_cancel' class='ico_input_empty'></button>";
		html += "				</div>";
		html += "				<div id='files_home_search_combobox' style='display: none;'>";
		html += "					<div class='combobox_wrap'>";
		html += "						<div id='combobox_folder_category' class='cbbox'>";
		html += "							<span>유형</span>";
		html += "							<span class='btn_ico'></span>";
		html += "						</div>";
		html += "						<div id='combobox_edit_date' class='cbbox'>";
		html += "							<span>수정일</span>";
		html += "							<span class='btn_ico'></span>";
		html += "						</div>";
		html += "						<div id='combobox_folder_emp' class='cbbox'>";
		html += "							<span>사람</span>";
		html += "							<span class='btn_ico'></span>";
		html += "						</div>";
		html += "					</div>";
		...
		html += "			<div id='files_home_content' class='files_home_content_wrap'></div>";
		
		html += "		</div>";
		html += "	</div>";
		html += "</div>";
		
		$("#files_home_container").remove();
		$("#sub_channel_content").append(html);
		
		this.draw_files_home_content();
		this.event_files_home();
	},
	
	"event_files_home" : function(){
		
		$("#input_files_search_home").off().on("keyup", function(e){
		...
		// 검색 버튼
		$("#btn_files_home_search").off().on("click", function(){
			
			var val = $.trim( $("#input_files_search_home").val() );
			
			if( val !== "" ){
				$(this).hide();
				$("#btn_files_home_search_cancel").show();
				$("#btn_files_home_search").css({
					"filter" : "brightness(1)"
				});
				
				gFiles.draw_files_home_search();	
			} else {
				mobiscroll.toast({
					message: "검색어를 입력해주세요.", color:'danger'
				});
				return false;
			}
		...
		/// 검색취소 버튼
		$("#btn_files_home_search_cancel").off().on("click", function(){
			$(this).hide();
			$("#input_files_search_home").val("");
			$("#btn_files_home_search").css({
				"filter" : "brightness(1)"
			});
			$("#btn_files_home_search").show();
			
			$("#files_home_search_combobox").hide();
			$("#files_home_content").hide();
			
			
			gFiles.draw_files_home_content();
			$("#close_sidebar_files_summary").click();

		});
		
		$("#combobox_folder_category").off().on("click", function(){
			$(this).toggleClass("open");
			gFiles.draw_dropdown_files_filter_categroy();
		});
		
		$("#combobox_edit_date").off().on("click", function(){
			$(this).toggleClass("open");
			gFiles.draw_dropdown_files_filter_mod_date();
		});
		
		$("#combobox_folder_emp").off().on("click", function(){
			$(this).toggleClass("open");
			gFiles.draw_dropdown_files_filter_emp();
		});
		
	},
	
///////// Files 검색 필터 드롭다운 메뉴 그리는 함수 ////////


	/////// 유형별 필터 드롭다운 ///////
	"draw_dropdown_files_filter_categroy" : function(){
		
		var html = "";
		
		html += "<div id='dropdown_files_filter_categroy' class='dropdown_files_search_cbbox'>";
		
		html += "	<div class='dropdown_ul'>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico folder'></span>";
		html += "			<span class='li_txt'>Folder</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico ppt'></span>";
		html += "			<span class='li_txt'>PPT</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico word'></span>";
		html += "			<span class='li_txt'>Word</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico excel'></span>";
		html += "			<span class='li_txt'>Excel</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico pdf'></span>";
		html += "			<span class='li_txt'>PDF</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico img'></span>";
		html += "			<span class='li_txt'>Image</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico movie'></span>";
		html += "			<span class='li_txt'>Video</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico txt'></span>";
		html += "			<span class='li_txt'>Txt</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico etc'></span>";
		html += "			<span class='li_txt'>Etc</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_ico hwp'></span>";
		html += "			<span class='li_txt'>HWP</span>";
		html += "		</div>";
		...
		if($("#dropdown_files_filter_categroy").length === 0){
			$("#combobox_folder_category").append(html);
		}
		
		$("#dropdown_files_filter_categroy").slideToggle(200);
		
		$("#dropdown_files_filter_categroy .dropdown_li").off().on("click", function(e){
			e.stopPropagation();
		});
		
		$(document).on("click", function(e){
			
			if(!$(e.target).closest("#combobox_folder_category").length){
				$("#combobox_folder_category").removeClass("open");
				$("#dropdown_files_filter_categroy").remove();
			}
		});
	},
	
	/////// 수정일별 필터 드롭다운 ///////
	"draw_dropdown_files_filter_mod_date" : function(){

		var html = "";
		
		html += "<div id='dropdown_files_filter_mod_date' class='dropdown_files_search_cbbox'>";
		
		html += "	<div class='dropdown_ul'>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_txt'>오늘</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_txt'>지난 7일</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_txt'>지난 30일</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_txt'>올해</span>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		html += "			<span class='li_txt'>지난해</span>";
		html += "		</div>";
		html += "	</div>";
		
		html +=	"</div>";
		
		if($("#dropdown_files_filter_mod_date").length === 0){
			$("#combobox_edit_date").append(html);
		}
		
		$("#dropdown_files_filter_mod_date").slideToggle(200);
		
		$("#dropdown_files_filter_mod_date .dropdown_li").off().on("click", function(e){
			e.stopPropagation();
		});
		
		$(document).on("click", function(e){
			
			if(!$(e.target).closest("#combobox_edit_date").length){
				$("#combobox_edit_date").removeClass("open");
				$("#dropdown_files_filter_mod_date").remove();
			}
		});
	...
	/////// 사원별 필터 드롭다운 ///////
	"draw_dropdown_files_filter_emp" : function(){
		
		var html = "";
		
		html += "<div id='dropdown_files_filter_emp' class='dropdown_files_search_cbbox'>";
		
		html += "	<div class='search_emp_input_wrap'>";
		html += "		<input type='text' id='input_files_filter_search_emp' class='search_emp_input' placeholder='이름을 검색하세요.' autocomplete='off' spellcheck='false' >";
		html += "		<button type='button' id='btn_files_filter_search_emp' class='search_ico'></button>";
		html +=	"	</div>";
		
		html += "	<div class='dropdown_ul'>";
		html += "		<div class='dropdown_li'>";
		html += "			<div class='emp_info_wrap'>";
		html += "				<span class='emp_img' style='background-image: url(/photo/KM0099.jpg), url(../resource/images/none.jpg)'></span>";
		html += "				<div class='emp_detail_wrap'>";
		html += "					<span class='emp_name'>박대민</span>";
		html += "					<span class='emp_dept'>기술전략팀</span>";
		html += "				</div>";
		html += "			</div>";
		html += "		</div>";
		html += "		<div class='dropdown_li'>";
		...
		if($("#dropdown_files_filter_emp").length === 0){
			$("#combobox_folder_emp").append(html);
		}
		
		$("#dropdown_files_filter_emp").slideToggle(200, function(){
			$("#input_files_filter_search_emp").focus();
		});
		
		$("#dropdown_files_filter_emp > *").off().on("click", function(e){
			e.stopPropagation();
		});
		
		$("#btn_files_filter_search_emp").off().on("click", function(){
			$('#input_files_filter_search_emp').val("");
			
			/// 검색관련 소스
		});
		$("#input_files_filter_search_emp").off().on("keyup focus blur", function(e){
			if(e.type === "keyup"){
				if(e.keyCode === 13){
					$("#btn_files_filter_search_emp").click();
				}
			}
		...
		$(document).on("click", function(e){
			if(!$(e.target).closest("#combobox_folder_emp").length){
				$("#combobox_folder_emp").removeClass("open");
				$("#dropdown_files_filter_emp").remove();
			}
		});
		
	},
	
///////// Files 검색 필터 콤보박스 그리는 함수 ////////
	
	"draw_files_home_content" : function(){
		
		var html = "";
		
		html += "			<div class='section_dashboard'>";
		
		html += "				<div class='dashboard_top'>";
		
		html += "					<div class='tab_ul'>";
		html += "						<div id='tab_recent_files' class='tab_li active'><span>Recent</span></div>";
		html += "						<div id='tab_starred_files' class='tab_li'><span>Starred</span></div>";
		html += "					</div>";
		
		html += "					<div id='files_home_tab_items' class='tab_item_wrap'></div>";
		html += "				</div>";
		
		html += "				<div class='dashboard_content'>";
		html += "					<h4 class='content_title'>Activity Feeds</h4>";
		html += "					<div class='feed_ul'>";
		html += "						<div class='feed_li'>";
		html += "							<img class='feed_img' style='background-image:url(/photo/KM0099.jpg),url(../resource/images/none.jpg);'>";
		html += "							<div class='feed_info_box_wrap'>";
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico word'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		html += "										</div>";
		html += "										<div class='desc_bot'>";
		html += "											<div class='folder_ico'></div>";
		html += "											<div class='folder_name'>Data Analysis</div>";
		html +=	"										</div>";
		html += "									</div>";
		html += "								</div>";
		html += "							</div>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico excel'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico ppt'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico pdf'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico txt'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico zip'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico movie'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico img'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico etc'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico hwp'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "								<div class='comment'>박대민이 파일을 수정했습니다.</div>";
		html += "								<div class='feed_info_box'>";
		html += "									<div class='icon_wrap'><span class='ico thumbnail'></span></div>";
		html += "									<div class='desc_wrap'>";
		html += "										<div class='desc_top'>";
		html += "											<div class='desc_top_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "											<span class='time'>오전 10:43</span>";
		...
		html += "			<div class='section_activity_log'>";
		html += "				<h4 class='section_title'>Activity Log</h4>";
		html +=	"				<div class='log_ul'>";
		html += "					<div class='log_li'>";
		html += "						<img class='log_img' style='background-image:url(/photo/KM0099.jpg),url(../resource/images/none.jpg);'>";
		html += "						<div class='log_info_box_wrap'>";
		html += "							<div class='comment'>박대민이 사용자를 추가했습니다.</div>";
		html += "							<div class='log_info_box'>";
		html += "								<div class='icon_wrap'><span class='ico folder'></span></div>";
		html += "								<div class='desc_wrap'>";
		html += "									<div class='desc_title'>amplitude_Monthly_Report_mau.csv</div>";
		html += "									<span class='time'>오전 10:43</span>";
		html += "								</div>";
		html += "							</div>";
		html += "						</div>";
		...
		$("#files_home_content").empty();
		$("#files_home_content").append(html);

		/*var swiper = new Swiper('#files_home_tab_items', {
			//loop: true,
			slidesPerView: 4,
			spaceBetween: 16,
			speed: 300,
		...
		gFiles.init_files_home_tab_item("recent");
		
		$("#files_home_search_nav").hide();
		$("#files_home_content").hide();
		$("#files_home_container .inner").removeClass("search");
		
		setTimeout(function(){
			
			$("#files_home_search_nav").fadeIn(200, function(){
				$("#input_files_search_home").focus();
			});
			
			$("#files_home_content").fadeIn(200);
			
		}, 200);
		
		$("#tab_recent_files").off().on("click", function(){
			$("#tab_starred_files").removeClass("active");
			$(this).addClass("active");
			gFiles.init_files_home_tab_item("recent");
		});
		$("#tab_starred_files").off().on("click", function(){
			$("#tab_recent_files").removeClass("active");
			$(this).addClass("active");
			gFiles.init_files_home_tab_item("star");
		});
		
	},
	
	"init_files_home_tab_item" : function(opt){
		...
		if(opt === "recent"){
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico hwp'></span></div>";
			html += "									<h4 class='title'>amplitude_Monthly Report_dashboard report.hwp</h4>";
			html += "									<span class='desc'>Data Analysis</span>";
			html += "								</div>";
			html += "								<span class='time'>오전 10:25</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico pdf'></span></div>";
			html += "									<h4 class='title'>amplitude_Monthly Report_dashboard report.pdf</h4>";
			html += "									<span class='desc'>Data Analysis</span>";
			html += "								</div>";
			html += "								<span class='time'>오전 10:25</span>";
			html += "							</div>";
			...
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico excel'></span></div>";
			html += "									<h4 class='title'>amplitude_Monthly Report_mau.xls</h4>";
			html += "									<span class='desc'>Data Analysis</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.22</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico txt'></span></div>";
			html += "									<h4 class='title'>architectural building design.txt</h4>";
			html += "									<span class='desc'>Stock txt</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico zip'></span></div>";
			html += "									<h4 class='title'>Space concept design.zip</h4>";
			html += "									<span class='desc'>Stock zips</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico movie'></span></div>";
			html += "									<h4 class='title'>Space concept design.mp4</h4>";
			html += "									<span class='desc'>Stock movies</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico thumbnail'></span></div>";
			html += "									<h4 class='title'>architectural building design.jpg</h4>";
			html += "									<span class='desc'>Stock Images</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico img'></span></div>";
			html += "									<h4 class='title'>Space concept design.png</h4>";
			html += "									<span class='desc'>images</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico folder'></span></div>";
			html += "									<h4 class='title'>Space concept design</h4>";
			html += "									<span class='desc'>root</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "							<div class='swiper-slide tab_item'>";
			html += "								<div class='info_wrap'>";
			html += "									<div class='icon_wrap'><span class='ico etc'></span></div>";
			html += "									<h4 class='title'>Space concept design.js</h4>";
			html += "									<span class='desc'>JS_folder</span>";
			html += "								</div>";
			html += "								<span class='time'>2025.05.23</span>";
			html += "							</div>";
			html += "						</div>";	
		...
		$("#files_home_tab_items").empty();
		$("#files_home_tab_items").append(html);
		
		if( $("#files_home_tab_items .tab_item").length <= 4 ){
			/// 슬라이드 페이지네이션 없을 떄 하단 margin 추가
			$("#files_home_tab_items").css({
				"margin-bottom" : "36px"
			});
		} else {
			$("#files_home_tab_items").css({
	...
	//// files 검색 결과 화면 그리는 함수
	"draw_files_home_search" : function(){
		
		var html = "";
		
		html += "<div id='files_home_search_result'>";
		html += "	<div id='files_home_search_file_ul' class='search_file_ul'></div>";
		html += "</div>";
		...
		gFiles.draw_files_home_search_list();
		
		$("#files_home_content").hide();
		$("#files_home_container .inner").addClass("search");
		
		$("#files_home_search_file_ul").hide();
		$("#files_home_search_combobox").fadeIn();
		$("#files_home_content").fadeIn();
		
		setTimeout(function(){
			$("#files_home_search_file_ul").fadeIn();
		}, 400);

		gFiles.event_files_home_search();
		
	},
	
	/// files 검색 결과 리스트 그리는 함수
	"draw_files_home_search_list" : function(){
		
		var html = "";
		
		html += "		<div class='file_li'>";
		html += "			<div class='icon_wrap'><span class='ico folder'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'><span class='keyword'>Marketing</span></h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico clock'></div>";
		html += "						<span class='desc_txt'>2025.05.22</span>";
		html += "					</div>";
		html += "					<span class='dot'>ㆍ</span>";
		html += "					<div class='desc_box'>";
		html += "						<span class='desc_txt'>Park Sang Hyun</span>";
		html += "					</div>";
		html += "				</div>";
		html += "			</div>";
		html += "			<div class='btn_wrap'>";
		html += "				<button type='button' class='btn_summation'><span class='btn_ico'></span></button>";
		html += "				<button type='button' class='btn_more'><span class='btn_ico'></span></button>";
		html +=	"			</div>";
		html += "		</div>";
		html += "		<div class='file_li'>";
		html += "			<div class='icon_wrap'><span class='ico pdf'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'><span class='keyword'>Marketing</span> Argenda for <span class='keyword'>Cobalt circle</span>.pdf</h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico folder'></div>";
		html += "						<span class='desc_txt'>Design</span>";
		html += "					</div>";
		html += "					<span class='dot'>ㆍ</span>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico clock'></div>";
		...
		html += "					<span class='dot'>ㆍ</span>";
		html += "					<div class='desc_box'>";
		html += "						<span class='desc_txt'>Kim Ji Young</span>";
		html += "					</div>";
		html += "				</div>";
		html += "				<div class='detail_txt_wrap'><span class='keyword'>Marketing</span> Argenda for <span class='keyword'>Cobalt Circle</span> (November 1, 2025- March 31, 2025) \n This <span class='keyword'>marketing</span> agenda outline the key tasks, dead lines, and timelines for <span class='keyword'>Cobalt Circle</span>’s ongoing marketing</div>";
		html += "			</div>";
		html += "			<div class='btn_wrap'>";
		html += "				<button type='button' class='btn_summation'><span class='btn_ico'></span></button>";
		html += "				<button type='button' class='btn_more'><span class='btn_ico'></span></button>";
		...
		html += "			<div class='icon_wrap'><span class='ico ppt'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'>Consulting proposal for <span class='keyword'>Cobalt Circle</span>.ppt</h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico folder'></div>";
		html += "						<span class='desc_txt'>Design</span>";
		...
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico clock'></div>";
		html += "						<span class='desc_txt'>2025.05.21</span>";
		html += "					</div>";
		html += "					<span class='dot'>ㆍ</span>";
		html += "					<div class='desc_box'>";
		html += "						<span class='desc_txt'>Park Sang Hyun</span>";
		...
		html += "			<div class='icon_wrap'><span class='ico thumbnail'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'><span class='keyword'>marketing</span> plan.png</h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico folder'></div>";
		html += "						<span class='desc_txt'>Design</span>";
		...
		html += "			<div class='icon_wrap'><span class='ico img'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'><span class='keyword'>cobalt</span> brainstorming.jpg</h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico folder'></div>";
		html += "						<span class='desc_txt'>Design</span>";
		...
		html += "			<div class='icon_wrap'><span class='ico word'></span></div>";
		html += "			<div class='info_wrap'>";
		html += "				<h4 class='title'><span class='keyword'>Marketing Plan</span> : <span class='keyword'>Cobalt Circle</span>.docx</h4>";
		html += "				<div class='desc_box_wrap'>";
		html += "					<div class='desc_box'>";
		html += "						<div class='desc_ico folder'></div>";
		html += "						<span class='desc_txt'>Design</span>";
		...
		html += "					<span class='dot'>ㆍ</span>";
		html += "					<div class='desc_box'>";
		html += "						<span class='desc_txt'>Kang So Ra</span>";
		html += "					</div>";
		html += "				</div>";
		html += "				<div class='detail_txt_wrap'><span class='keyword'>Marketing Plan</span> for <span class='keyword'>Cobalt Circle</span> This <span class='keyword'>marketing plan</span> outline strategy for launching and promoting <span class='keyword'>Cobalt Circle</span>, an automotive advertising agency, with a comprehensive media</div>";
		html += "			</div>";
		html += "			<div class='btn_wrap'>";
		html += "				<button type='button' class='btn_summation'><span class='btn_ico'></span></button>";
		html += "				<button type='button' class='btn_more'><span class='btn_ico'></span></button>";
		...
		$("#files_home_search_file_ul").append(html);
		
	},
	
	"event_files_home_search" : function(){
		
		$("#files_home_search_file_ul .btn_summation").off().on("click", function(){
			gFiles.draw_summary_files_search();
		});
		
	},
	
	////// Files 검색 후 파일 
	"draw_summary_files_search" : function(){
		var html = "";
		
		html += "<div id='sidebar_files_summary'>";
		html += "	<div class='resize_handle'></div>";
		html += "	<div class='left_line'></div>";
		html += "	<div class='content_inner'>";
		
		//// 타이틀
		html += "		<div class='title_box_wrap'>";
		html += "			<div class='title_box'>";
		html += "				<span class='title_ico'></span>";
		html += "				<h4 class='title_txt'>Summary</h4>";
		html += "			</div>";
		html += "			<button type='button' id='close_sidebar_files_summary' class='close_btn'><span class='btn_ico'></span></button>";
		html += "		</div>";
		
		///// 요약 영역
		html += "		<div class='summary_wrap'>";
		
		html += "			<div id='files_summary_list' class='summary_file_ul'>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico word'></span>";
		html += "					<span class='file_name'>Marketing Argenda for Cobalt circle.pdf</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico excel'></span>";
		html += "					<span class='file_name'>Maketing Plan : Cobalt Circle</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico ppt'></span>";
		html += "					<span class='file_name'>Marketing Argenda for Cobalt circle.pdf</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico pdf'></span>";
		html += "					<span class='file_name'>Consulting proposal for Cobalt Circle</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico txt'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico zip'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico movie'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico img'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico etc'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico hwp'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		...
		html += "				</div>";
		html += "				<div class='summary_file_li'>";
		html += "					<span class='ico thumbnail'></span>";
		html += "					<span class='file_name'>Cobalt circle Brainstrorming</span>";
		html += "					<button type='button' class='btn_remove_summary_file_li'></button>";
		html += "				</div>";
		html += "			</div>";
		
		html += "			<div class='sumamry_txt_box_wrap'>";
		html += "				<div class='sumamry_txt_box'>Cobalt Circle’s marketing plan aims to establish the agency as a leader in automotive advertising through a multifaceted media campaign. The strategy combines traditional and digital marketing to enhance brand visibility and engage key industry stakeholders.</div>";
		
		html += "				<div class='sumamry_txt_box'>";
		html += "					<div class='sumamry_txt_box_title'>Marketing Objectives</div>";
		html += "					<div class='sumamry_txt_box_desc'>Focus on brand awareness, client engagement, market positioning, and lead generation through events, social media, and sponsorships.</div>";
		html += "				</div>";
		html += "				<div class='sumamry_txt_box'>";
		html += "					<div class='sumamry_txt_box_title'>Target Audience</div>";
		html += "					<div class='sumamry_txt_box_desc'>Focus on brand awareness, client engagement, market positioning, and lead generation through events, social media, and sponsorships.</div>";
		html += "				</div>";
		html += "				<div class='sumamry_txt_box'>";
		html += "					<div class='sumamry_txt_box_title'>Marketing Objectives</div>";
		html += "					<div class='sumamry_txt_box_desc'>Key segments include automotive dealerships, manufacturers, aftermarket services, enthusiasts, and corporate partners in motorsports.</div>";
		html += "				</div>";
		html += "			</div>";
		html += "		</div>";
		...
		html += "			<input type='text' id='input_files_ai_question' class='question_input' placeholder='궁금한 사항을 물어보세요.' autocomplete='off' spellcheck='false'>";
		html += "			<button type='button' id='btn_files_ai_question' class='button_files_ai_question'></button>";
		html += "		</div>";
		
		html += "	</div>";
		html += "</div>";
		
		if( $("#sidebar_files_summary").length === 0 ){
			$("#sidebar_files_summary").remove();
			$("#files_home_container").append(html);
			
			setTimeout(function(){
				
				$("#files_home_container .inner_wrap").css({
					"margin-right" : "480px"
				});
				$("#sidebar_files_summary").css({
					"width" : "480px"
				});
				$("#files_home_container .inner_wrap").css({
					"z-index" : "1"
				});
				$(".btn-quick-alarm-wrap").css({
					"right" : "485px"
				});
				
				$("#sidebar_files_summary .content_inner").css({
					"visibility" : "visible",
					"opacity" : "1"
				});
				
				
				/// 사이드바가 표시된 후 border를 그린다.
				$("#sidebar_files_summary .left_line").css({
					"height" : "100%"
				});
		...
		gFiles.event_sidebar_files_summary();
		
	},
	
	//// Files 검색요약 사이드바 이벤트 함수
	"event_sidebar_files_summary" : function(){
		
		//// 닫기
		$("#close_sidebar_files_summary").off().on("click", function(){
				
			var timer = parseFloat($("#sidebar_files_summary").css("transition-duration")) * 1000;
			
			requestAnimationFrame(function(){
				
				$("#sidebar_files_summary .content_inner").fadeOut(200);
		...
		$("#files_summary_list .btn_remove_summary_file_li").off().on("click", function(){
			$(this).parent(".summary_file_li").remove();
		});
		
		$("#btn_files_ai_question").off().on("click", function(){
			$("#input_files_ai_question").val("");
		});
		
		$("#input_files_ai_question").off().on("keyup", function(e){
	...
	"drive_left_draw" : function(){
		...
		var html = 	
			...
			'				<ul>' +
			'					<li class="lnb-home on" id="files_home"><em><span class="ico" style="margin-top:8px"></span></em></li>' +
			'					<li class="lnb-all" id="allcontent_drive"><em><span class="ico"  style="margin-top:8px"></span></em></li>' +
	...
	"drive_left_event_handler" : function(){
		...
		$("#channel_option li").off().on("click", function(e){			
			...
			if ( id === "files_home"){
				/// 홈
				_self.select_left_menu = "0";
			} else if (id == "allcontent_drive"){
	...
	"show_drive" : function(){
		...
		//드라이브 목록 표시하기
		$("#files_home em").html("<span class='ico' style='margin-top:8px'></span>Files Home");
...
//		html += '	<button><strong>' + gap.lang.OK + '</strong></button>';
	...
	"draw_drive_left" : function(res){
		...
		if (typeof(res.drive) != "undefined"){
			...
			// 드라이브 하위 폴더 그리기
			this.draw_main_sub_folder(res.folder);		
		}
