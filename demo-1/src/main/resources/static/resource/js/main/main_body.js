...
//				return false;
		...
		$("#open_emoticon_backup").on("click", function(){
			...
			html += "	<ul class='list-emoticon' id='emoti_dis' style='overflow:hidden'>";			
			html += "		<li><img src='/resource/images/emoticons/rio.gif' data='rio.gif'></li>";
			html += "		<li><img src='/resource/images/emoticons/lala.gif' data='lala.gif'></li>";					
			for (var k = 1; k < 41; k++){
				html += "		<li><img src='/resource/images/emoticons/"+k+".gif' data='"+k+".gif'></li>";
			}			
			html += "	</ul>";
...
//				}			
			...
			if (msg.ky != gap.userinfo.rinfo.ky){
				...
				if (gap.cur_window == "chat" || gBody3.cur_window == "channel"){
					gBody.unread_chat_count_check_realtime();
				}else{
